...
- 在线文档：https://chang-xinhai.github.io/WxEcho
- 源码：https://github.com/chang-xinhai/WxEcho/tree/main/docs

### 维护流程

1. 文档基于 GitHub Pages 托管，source 在 `docs/` 目录
2. 修改 `docs/` 目录下的 Markdown 文件后推送到 `main` 分支
3. GitHub Actions 自动构建并发布到 https://chang-xinhai.github.io/WxEcho
